...
static public class MeshColliderTools
{
    ...
    //Modified by me to take vertices and triangles rather than a complete mesh
    ...
    public static meshData Simplify(Vector3[] meshVerts, int[] meshTris)
    {
        ...
        meshDataStruct.verts = newPositions;
        meshDataStruct.tris = resultTris.ToArray();

        return meshDataStruct;
        //mesh.Clear();
